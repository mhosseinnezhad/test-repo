package com.modernisc.security.keycloak.requiredaction.action.required;

import com.modernisc.security.keycloak.KeycloakSmsConstants;
import com.modernisc.security.keycloak.MobileNumberHelper;
import com.modernisc.security.keycloak.KeycloakSmsAuthenticatorUtil;
...
public class KeycloakSmsMobilenumberRequiredAction implements RequiredActionProvider {
    ...
    public void processAction(RequiredActionContext context) {
        ...
        if (answer != null && answer.length() > 0 && KeycloakSmsAuthenticatorUtil.isPhoneNumberValid(answer)) {
